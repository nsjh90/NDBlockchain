...
it('can add the star name and star symbol properly', async() => {
    ...
    //2. Call the name and symbol properties in your Smart Contract and compare with the name and symbol provided
        ...
        assert.equal(ContractName,'NStarToken');
        assert.equal(ContractSymbol,'NST');
...
it('lets 2 users exchange stars', async() => {
    ...
    let starId_1 = 7;
    let starId_2 = 8;
    await instance.createStar('user1star',starId_1, {from: user1});
    await instance.createStar('user2star',starId_2, {from: user2});
    await instance.exchangeStars(starId_1,starId_2);
    let firstStar = await instance.ownerOf.call(starId_1);
    let secondStar = await instance.ownerOf.call(starId_2);
...
it('lets a user transfer a star', async() => {
    ...
    let user2 = accounts[1];
    let starId = 9;
    await instance.createStar('user1star',starId, {from: user1});
